...
import { notesResponseSchema, createNotesPrompt, NOTES_SYSTEM_PROMPT } from "../notes";

describe("notes prompts", () => {
  describe("NOTES_SYSTEM_PROMPT", () => {
    it("should contain guidelines for creating notes", () => {
      expect(NOTES_SYSTEM_PROMPT).toContain("extract structured, comprehensive notes");
